...
public:
     ...
     * serial device
     */
    AsyncSerial(const std::string& devname,
                unsigned int baud_rate,
                serial_port_base::parity opt_parity = serial_port_base::parity(serial_port_base::parity::none),
                serial_port_base::character_size opt_csize = serial_port_base::character_size(8),
                serial_port_base::flow_control opt_flow = serial_port_base::flow_control(serial_port_base::flow_control::none),
...
public:
    ...
    * serial device
    */
    CallbackAsyncSerial(const std::string& devname,
                        unsigned int baud_rate,
                        serial_port_base::parity opt_parity = serial_port_base::parity(serial_port_base::parity::none),
                        serial_port_base::character_size opt_csize = serial_port_base::character_size(8),
                        serial_port_base::flow_control opt_flow = serial_port_base::flow_control(serial_port_base::flow_control::none),
